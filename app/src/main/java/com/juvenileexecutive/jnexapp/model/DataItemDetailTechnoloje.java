...
public class DataItemDetailTechnoloje {

    public static ArrayList<ItemDetailModel> generateDataTechnoloje(){
        ArrayList<ItemDetailModel> detailTechItems = new ArrayList<>();

        detailTechItems.add(new ItemDetailModel(
