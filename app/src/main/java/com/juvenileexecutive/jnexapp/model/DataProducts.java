...
public class DataProducts {
    ...
    public static ArrayList<ProductsModel> generateDataProduct(){
        ...
        productItems.add(new ProductsModel("title1", "description", R.drawable.ic_launcher_background));
        productItems.add(new ProductsModel("title2", "description", R.drawable.ic_launcher_background));
        productItems.add(new ProductsModel("title3", "description", R.drawable.ic_launcher_background));
