...
public class DataItemDetailJEstate {

    public static ArrayList<ItemDetailModel> generateDataJEstate(){
        ArrayList<ItemDetailModel> detailJestateItems = new ArrayList<>();

        detailJestateItems.add(new ItemDetailModel(
